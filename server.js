...
app.get('/api/seed', (req, res) => {
  ...
  const seeds = [
    // ── TODAY Mar 20 ─────────────────────────────────────────
    // MUN 74% → H3 (70-74 = H3)
    {match_id:'bou_mun',date:d0,league:'Premier League',league_flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',home_team:'AFC Bournemouth',away_team:'Manchester United',favorite:'Manchester United',handicap:'H3',handicap_label:'Man United H3',win_condition:'Win by 3+ goals',probability:74,is_banker:0,bookmaker:'Bet9ja',odds:2.10,status:'pending',home_form:'LWDLL',away_form:'WWDLW',h2h_summary:'MUN 5W last 8',insights:['Away side stronger','United good form','Bournemouth inconsistent'],match_time:'21:00'},
    // RBL 83% → H1 banker (80-89 = H1)
    {match_id:'rbl_tsg',date:d0,league:'Bundesliga',league_flag:'🇩🇪',home_team:'RB Leipzig',away_team:'TSG Hoffenheim',favorite:'RB Leipzig',handicap:'H1',handicap_label:'RB Leipzig H1',win_condition:'Win by 1+ goals',probability:83,is_banker:1,bookmaker:'Bet9ja',odds:1.55,status:'pending',home_form:'WWWDW',away_form:'LLDLL',h2h_summary:'RBL 6W last 8 home',insights:['🔥 Leipzig sharp','Hoffenheim away poor','High scoring games'],match_time:'20:30'},
    // Lens 82% → H1 banker (80-89 = H1)
    {match_id:'rcl_ang',date:d0,league:'Ligue 1',league_flag:'🇫🇷',home_team:'Racing Club De Lens',away_team:'Angers SCO',favorite:'Racing Club De Lens',handicap:'H1',handicap_label:'Lens H1',win_condition:'Win by 1+ goals',probability:82,is_banker:1,bookmaker:'1xBet',odds:1.55,status:'pending',home_form:'WWWDW',away_form:'LLLLL',h2h_summary:'RCL 5W last 7 home',insights:['🔥 Lens dominant','Angers bottom','Strong home form'],match_time:'20:45'},
    // ── MAR 21 ───────────────────────────────────────────────
    // Liverpool 78% → H2 (75-79 = H2)
    {match_id:'bri_liv',date:d1,league:'Premier League',league_flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',home_team:'Brighton',away_team:'Liverpool',favorite:'Liverpool',handicap:'H2',handicap_label:'Liverpool H2',win_condition:'Win by 2+ goals',probability:78,is_banker:0,bookmaker:'Bet9ja',odds:2.00,status:'pending',home_form:'DWLDD',away_form:'WWWDW',h2h_summary:'LIV 6W last 9',insights:['Liverpool title charge','Brighton solid home','Away side stronger'],match_time:'13:30'},
    // Fulham 84% → H1 banker (80-89 = H1)
    {match_id:'ful_bur',date:d1,league:'Premier League',league_flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',home_team:'Fulham',away_team:'Burnley',favorite:'Fulham',handicap:'H1',handicap_label:'Fulham H1',win_condition:'Win by 1+ goals',probability:84,is_banker:1,bookmaker:'1xBet',odds:1.50,status:'pending',home_form:'WWWDW',away_form:'LLLLD',h2h_summary:'FUL 5W last 6 home',insights:['🔥 Home dominant','Burnley bottom 3','Avg 3.1 goals'],match_time:'16:00'},
    // Chelsea 76% → H2 (75-79 = H2)
    {match_id:'eve_che',date:d1,league:'Premier League',league_flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',home_team:'Everton',away_team:'Chelsea',favorite:'Chelsea',handicap:'H2',handicap_label:'Chelsea H2',win_condition:'Win by 2+ goals',probability:76,is_banker:0,bookmaker:'Betway',odds:2.05,status:'pending',home_form:'LLDLL',away_form:'WWWLW',h2h_summary:'CHE 4W last 6',insights:['Chelsea in form','Everton relegation zone','Strong away record'],match_time:'18:30'},
    // Bayern 87% → H1 banker (80-89 = H1)
    {match_id:'bmu_uni',date:d1,league:'Bundesliga',league_flag:'🇩🇪',home_team:'Bayern Munich',away_team:'Union Berlin',favorite:'Bayern Munich',handicap:'H1',handicap_label:'Bayern H1',win_condition:'Win by 1+ goals',probability:87,is_banker:1,bookmaker:'Bet9ja',odds:1.40,status:'pending',home_form:'WWWDW',away_form:'LLLLL',h2h_summary:'BAY 9W last 10 home',insights:['🔥 Bayern unstoppable','Union Berlin bottom','Kane in top form'],match_time:'15:30'},
    // Dortmund 76% → H2 (75-79 = H2)
    {match_id:'bvb_hsv',date:d1,league:'Bundesliga',league_flag:'🇩🇪',home_team:'Borussia Dortmund',away_team:'Hamburger SV',favorite:'Borussia Dortmund',handicap:'H2',handicap_label:'Dortmund H2',win_condition:'Win by 2+ goals',probability:76,is_banker:0,bookmaker:'Betway',odds:2.00,status:'pending',home_form:'WWWLW',away_form:'LLDLL',h2h_summary:'BVB 5W last 7 home',insights:['Dortmund strong home','HSV newly promoted','Signal Iduna atmosphere'],match_time:'18:30'},
    // Leverkusen 75% → H2 (75-79 = H2)
    {match_id:'fch_lev',date:d1,league:'Bundesliga',league_flag:'🇩🇪',home_team:'1. FC Heidenheim',away_team:'Bayer Leverkusen',favorite:'Bayer Leverkusen',handicap:'H2',handicap_label:'Leverkusen H2',win_condition:'Win by 2+ goals',probability:75,is_banker:0,bookmaker:'1xBet',odds:2.10,status:'pending',home_form:'LLDLL',away_form:'WWWDW',h2h_summary:'LEV 5W last 7',insights:['Leverkusen title push','Heidenheim struggling','Away side dominant'],match_time:'15:30'},
    // Elche 71% → H3 (70-74 = H3)
    {match_id:'elc_mal',date:d1,league:'La Liga',league_flag:'🇪🇸',home_team:'Elche CF',away_team:'RCD Mallorca',favorite:'Elche CF',handicap:'H3',handicap_label:'Elche H3',win_condition:'Win by 3+ goals',probability:71,is_banker:0,bookmaker:'Bet9ja',odds:2.20,status:'pending',home_form:'WWDLW',away_form:'LWDLL',h2h_summary:'ELC 4W last 6 home',insights:['Home advantage','Mallorca away poor','Form edge'],match_time:'14:00'},
    // AC Milan 78% → H2 (75-79 = H2)
    {match_id:'acm_tor',date:d1,league:'Serie A',league_flag:'🇮🇹',home_team:'AC Milan',away_team:'Torino FC',favorite:'AC Milan',handicap:'H2',handicap_label:'AC Milan H2',win_condition:'Win by 2+ goals',probability:78,is_banker:0,bookmaker:'Bet9ja',odds:2.00,status:'pending',home_form:'WWWDL',away_form:'LLDLL',h2h_summary:'MIL 5W last 7 home',insights:['Milan top 4 push','Torino poor away','San Siro advantage'],match_time:'18:00'},
    // Juventus 83% → H1 banker (80-89 = H1)
    {match_id:'juv_sas',date:d1,league:'Serie A',league_flag:'🇮🇹',home_team:'Juventus Turin',away_team:'Sassuolo Calcio',favorite:'Juventus Turin',handicap:'H1',handicap_label:'Juventus H1',win_condition:'Win by 1+ goals',probability:83,is_banker:1,bookmaker:'1xBet',odds:1.50,status:'pending',home_form:'WWWLW',away_form:'LLDLL',h2h_summary:'JUV 5W last 6 home',insights:['🔥 Juve home record','Sassuolo poor away','Clean sheet streak'],match_time:'20:45'},
    // PSG 82% → H1 banker (80-89 = H1)
    {match_id:'nic_psg',date:d1,league:'Ligue 1',league_flag:'🇫🇷',home_team:'OGC Nice',away_team:'Paris Saint-Germain',favorite:'Paris Saint-Germain',handicap:'H1',handicap_label:'PSG H1',win_condition:'Win by 1+ goals',probability:82,is_banker:1,bookmaker:'Bet9ja',odds:1.50,status:'pending',home_form:'WDLDD',away_form:'WWWWL',h2h_summary:'PSG 6W last 8 away',insights:['🔥 PSG dominant','Nice mid-table','Away side superior'],match_time:'21:05'},
    // ── MAR 22 ───────────────────────────────────────────────
    // Newcastle 80% → H1 banker (80-89 = H1)
    {match_id:'new_sun',date:d2,league:'Premier League',league_flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',home_team:'Newcastle United',away_team:'Sunderland',favorite:'Newcastle United',handicap:'H1',handicap_label:'Newcastle H1',win_condition:'Win by 1+ goals',probability:80,is_banker:1,bookmaker:'Bet9ja',odds:1.55,status:'pending',home_form:'WWWDW',away_form:'LWLLD',h2h_summary:'NEW 5W last 7 home',insights:['Tyne-Wear Derby','Newcastle top 4 push','Sunderland away poor'],match_time:'14:00'},
    // Aston Villa 74% → H3 (70-74 = H3)
    {match_id:'avl_whu',date:d2,league:'Premier League',league_flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',home_team:'Aston Villa',away_team:'West Ham',favorite:'Aston Villa',handicap:'H3',handicap_label:'Aston Villa H3',win_condition:'Win by 3+ goals',probability:74,is_banker:0,bookmaker:'1xBet',odds:2.25,status:'pending',home_form:'WWWLW',away_form:'DLWLL',h2h_summary:'AVL 4W last 6',insights:['Villa European chase','West Ham inconsistent','Strong home crowd'],match_time:'16:15'},
    // Tottenham 72% → H3 (70-74 = H3)
    {match_id:'tot_nfo',date:d2,league:'Premier League',league_flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',home_team:'Tottenham',away_team:'Nottm Forest',favorite:'Tottenham',handicap:'H3',handicap_label:'Tottenham H3',win_condition:'Win by 3+ goals',probability:72,is_banker:0,bookmaker:'Betway',odds:2.30,status:'pending',home_form:'WWDWL',away_form:'WDLLL',h2h_summary:'TOT 4W last 7',insights:['Spurs home bounce','Forest travel badly','Top 4 battle'],match_time:'16:15'},
    // Barcelona 88% → H1 banker (80-89 = H1)
    {match_id:'bar_rvc',date:d2,league:'La Liga',league_flag:'🇪🇸',home_team:'FC Barcelona',away_team:'Rayo Vallecano',favorite:'FC Barcelona',handicap:'H1',handicap_label:'Barcelona H1',win_condition:'Win by 1+ goals',probability:88,is_banker:1,bookmaker:'Bet9ja',odds:1.40,status:'pending',home_form:'WWWWW',away_form:'LLLDD',h2h_summary:'BAR 8W last 10 home',insights:['🔥 Barca 5 game streak','Rayo away terrible','Avg 3.6 goals at home'],match_time:'14:00'},
    // Real Madrid 73% → H3 (70-74 = H3)
    {match_id:'rma_atm',date:d2,league:'La Liga',league_flag:'🇪🇸',home_team:'Real Madrid',away_team:'Atletico Madrid',favorite:'Real Madrid',handicap:'H3',handicap_label:'Real Madrid H3',win_condition:'Win by 3+ goals',probability:73,is_banker:0,bookmaker:'Bet9ja',odds:2.40,status:'pending',home_form:'WWDWW',away_form:'WDWLW',h2h_summary:'RMA 5W last 8 home',insights:['Madrid home fortress','El Derbi tension','Title race crunch'],match_time:'21:00'},
    // Como 80% → H1 banker (80-89 = H1)
    {match_id:'com_pis',date:d2,league:'Serie A',league_flag:'🇮🇹',home_team:'Como 1907',away_team:'Pisa SC',favorite:'Como 1907',handicap:'H1',handicap_label:'Como H1',win_condition:'Win by 1+ goals',probability:80,is_banker:1,bookmaker:'Betway',odds:1.55,status:'pending',home_form:'WWWDL',away_form:'LLDLL',h2h_summary:'COM 5W last 7 home',insights:['Como strong home','Pisa away poor','Home dominance'],match_time:'12:30'},
    // Atalanta 80% → H1 banker (80-89 = H1)
    {match_id:'ata_ver',date:d2,league:'Serie A',league_flag:'🇮🇹',home_team:'Atalanta BC',away_team:'Hellas Verona',favorite:'Atalanta BC',handicap:'H1',handicap_label:'Atalanta H1',win_condition:'Win by 1+ goals',probability:80,is_banker:1,bookmaker:'1xBet',odds:1.50,status:'pending',home_form:'WWWWL',away_form:'LLLLL',h2h_summary:'ATA 6W last 8 home',insights:['Atalanta top form','Verona relegated zone','Goals machine'],match_time:'15:00'},
    // Inter 74% → H3 (70-74 = H3)
    {match_id:'fio_int',date:d2,league:'Serie A',league_flag:'🇮🇹',home_team:'ACF Fiorentina',away_team:'Inter Milano',favorite:'Inter Milano',handicap:'H3',handicap_label:'Inter H3',win_condition:'Win by 3+ goals',probability:74,is_banker:0,bookmaker:'Bet9ja',odds:2.30,status:'pending',home_form:'WWLWW',away_form:'WWWDW',h2h_summary:'INT 5W last 8',insights:['Inter title chasing','Fiorentina strong home','Away side quality'],match_time:'20:45'},
    // Roma 76% → H2 (75-79 = H2)
    {match_id:'rom_lec',date:d2,league:'Serie A',league_flag:'🇮🇹',home_team:'AS Roma',away_team:'US Lecce',favorite:'AS Roma',handicap:'H2',handicap_label:'Roma H2',win_condition:'Win by 2+ goals',probability:76,is_banker:0,bookmaker:'Betway',odds:2.00,status:'pending',home_form:'WWDWL',away_form:'LLLDD',h2h_summary:'ROM 5W last 7 home',insights:['Roma home fortress','Lecce relegation battle','Olimpico pressure'],match_time:'18:00'},
    // Rennes 82% → H1 banker (80-89 = H1)
    {match_id:'ren_fcm',date:d2,league:'Ligue 1',league_flag:'🇫🇷',home_team:'Stade Rennais FC',away_team:'FC Metz',favorite:'Stade Rennais FC',handicap:'H1',handicap_label:'Rennes H1',win_condition:'Win by 1+ goals',probability:82,is_banker:1,bookmaker:'1xBet',odds:1.50,status:'pending',home_form:'WWWDW',away_form:'LLLLD',h2h_summary:'REN 6W last 8 home',insights:['🔥 Rennes dominant','Metz bottom 3','Home goal machine'],match_time:'16:15'},
    // Marseille 73% → H3 (70-74 = H3)
    {match_id:'olm_lil',date:d2,league:'Ligue 1',league_flag:'🇫🇷',home_team:'Olympique Marseille',away_team:'Lille OSC',favorite:'Olympique Marseille',handicap:'H3',handicap_label:'Marseille H3',win_condition:'Win by 3+ goals',probability:73,is_banker:0,bookmaker:'Bet9ja',odds:2.40,status:'pending',home_form:'WWWLL',away_form:'WDLWL',h2h_summary:'OLM 4W last 7 home',insights:['Marseille Velodrome','Lille good form','Tight contest'],match_time:'16:15'},
  ];
  let added = 0;
  seeds.forEach(s => {
