...
app.get('/api/seed', (req, res) => {
  ...
  const seeds = [
    ...
    {match_id:'rbl_tsg',date:d0,league:'Bundesliga',league_flag:'🇩🇪',home_team:'RB Leipzig',away_team:'TSG Hoffenheim',favorite:'RB Leipzig',handicap:'H2',handicap_label:'RB Leipzig H2',win_condition:'Win by 2+ goals',probability:82,is_banker:1,bookmaker:'Bet9ja',odds:1.80,status:'pending',home_form:'WWWDW',away_form:'LLDLL',h2h_summary:'RBL 6W last 8 home',insights:['🔥 Leipzig sharp','Hoffenheim away poor','High scoring games'],match_time:'20:30'},
